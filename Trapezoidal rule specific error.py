#Trapezoidal estimation with specific error for integrals 
...
#------------------------------------------------------------------------
#finding number of steps to take based on prescribed error target of the trapezoid approx. using sympy & scipy library which allows for finding K/M by calculating the derivative & finding the maximum value
...
#calculate the actual error after rounding the steps
